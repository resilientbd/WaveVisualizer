...
public class WaveBarView extends View {
    ...
    public WaveBarView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public WaveBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public WaveBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mMode == MODE_RECORDING && temp != null) {
            ...
            if (mSamples != null) {
                ...
                for (int i = 0; i < density; i++) {
                    ...
                    canvas.drawLine(barX, getHeight(), barX, top, mStrokePaint);
                }
                super.onDraw(canvas);
            }
